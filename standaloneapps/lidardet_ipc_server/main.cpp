    ...
    ProgramArguments args(argc, argv,
                          {
                              ...
                              opt("tensorRTEngine", "", "Path to TensorRT engine file for object detection"),
                              opt("objectDetection", "true", "Enable object detection (requires TensorRT engine)"),
                              opt("minPoints", "120", "Minimum points required for valid detection (default: 120)"),

                              opt("freeSpace", "true", "Enable free space detection"),
                              opt("freeSpaceVisualization", "true", "Enable free space visualization"),
...
// ./lidar_object_detection_with_icp_free_space   --rigFile='/usr/local/driveworks-5.20/samples/src/sensors/lidar/lidar_object_detection_with_icp/rig.json'   --freeSpace=true   --freeSpaceVisualization=true --tensorRTEngine='/usr/local/driveworks-5.20/samples/src/sensors/lidar/lidar_object_detection_with_icp/model.engine'  --groundPlane=false   --groundPlaneVisualization=false   --objectDetection=true   --maxIters=50   > /usr/local/driveworks-5.20/samples/src/sensors/lidar/lidar_object_detection_with_icp/free_space_logs.txt 2>&1