    ...
    ProgramArguments args(argc, argv,
                          {
                              ...
                              opt("groundPlane", "true", "Enable ground plane extraction"),
                              opt("groundPlaneVisualization", "true", "Enable ground plane visualization (set to false if ground plane is incorrect)"),
