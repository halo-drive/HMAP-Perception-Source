the default nvidia driveowrks application dumps dw_gpsframes in stdout instead of separate csv. this is a customized version to dump data in the csv file, thus separating logs from frame data.
